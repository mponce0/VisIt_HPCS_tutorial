...
\begin{column}{5cm}
	...
	\end{itemize}
	\end{block}
	\includemovie[repeat=5]{\columnwidth}{\columnwidth}{figs/movies/aneurism_movie0.mp4}
\end{column}
\begin{column}{5cm}
	\includemovie[repeat=5]{\columnwidth}{\columnwidth}{figs/movies/aneurism_movie2.mp4}
\end{column}
\end{columns}
\end{frame}
