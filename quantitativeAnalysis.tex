...
\begin{frame}{Expressions}
  ...
  \item {\bf Option 1}: use Standar Editor to select existing functions and expressions \\\quad\ding{48}
  ...
  \item {\bf Option 2}: use Python Expression Editor - this is an advanced option for working
    with VTK objects \\\quad\ding{48} similar to the Programmable filter in ParaView
  \end{itemize}
\end{frame}
